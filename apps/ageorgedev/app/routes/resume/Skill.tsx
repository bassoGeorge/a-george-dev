...
const primaryAccentColorClasses: SkillClassMap = {
  ...
  5: highSkill + ' bg-rc-p-accent-400 text-cc-neutral-inverse',
};
...
const secondaryAccentColorClasses: SkillClassMap = {
  ...
  5: highSkill + ' bg-rc-s-accent-400 text-cc-neutral-inverse',
};
...
const levelClassesForHuman: SkillClassMap = {
  ...
  5: highSkill + ' bg-rc-timber-300 text-cc-neutral-inverse opacity-60',
};
