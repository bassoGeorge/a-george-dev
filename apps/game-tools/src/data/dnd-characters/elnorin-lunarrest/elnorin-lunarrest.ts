...
export const ElnorinData: Character = {
  ...
  spellcasting: {
    ...
    spells: [
      ...
      // TODO: add to attacks
      withSpellMods(SPELL.ShockingGrasp, { notes: '1d8 Lightning' }),
      // TODO: add to attacks
      SPELL.SorcerousBurst,
      SPELL.Guidance,
      SPELL.Thaumaturgy,
      withSpellMods(SPELL.HealingWord, {
        alwaysPrepared: true,
        freeUses: 1,
        notes: '2d4+3 Healing',
      }),
      withSpellMods(SPELL.Aid, { alwaysPrepared: true }),
      withSpellMods(SPELL.Alarm, { alwaysPrepared: true }),
      withSpellMods(SPELL.LesserRestoration, { alwaysPrepared: true }),
      withSpellMods(SPELL.ProtectionFromEvilAndGood, { alwaysPrepared: true }),
      SPELL.BurningHands,
      SPELL.DetectMagic,
      SPELL.Shield,
      SPELL.WitchBolt,
