...
### Requirement: char-test route renders ExampleSheet
**Reason**: Route migrated to `apps/game-tools` at `/dnd/characters/example`
**Migration**: Use `apps/game-tools` to access the character sheet
