...
import { InterfaceSm } from '../typography/typography-components';
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "relative flex cursor-default items-center gap-2 py-1 pr-2 pl-6 text-sm outline-hidden select-none focus:bg-primary-surface focus:text-primary-onsurface data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        'px-2 py-1 data-[inset]:pl-3 font-semibold text-neutral-subdued',
        InterfaceSm.classes,
        className
      )}
      {...props}
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn('-mx-1 my-1 h-px bg-neutral-disabled', className)}
      {...props}
    />
  );
}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        'ml-auto text-xs tracking-widest text-neutral-subdued',
        className
      )}
      {...props}
    />
